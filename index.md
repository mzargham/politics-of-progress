...
#### Position Breakdown
- **Technology**: Inherently good, must be accelerated
- **Markets**: Primary vehicle for innovation and coordination
- **Institutions**: Obstructive, outdated, often hostile to progress
- **Scarcity**: Artificial, imposed by regulation or ideology
- **Governance**: Should minimize interference with builders
...
#### Position Breakdown
- **Technology**: Crucial, but needs coordination and governance
- **Markets**: Important, but must be complemented by public investment
- **Institutions**: Capable of reform; necessary for equitable abundance
- **Scarcity**: Partly artificial, reinforced by outdated or misaligned policy
- **Governance**: Must be reformed to facilitate building and inclusion
...
1. **Technological Progress** – the belief that innovation is central to societal improvement.
2. **Institutional Constraints** – how bureaucracies, regulation, and legacy systems hinder or enable progress.
3. **Scarcity vs. Abundance** – debates over the nature of constraints and whether they are technical or political.
4. **The Role of the Market** – the function of markets in facilitating or distorting progress.
5. **The Crisis of Building** – systemic failure to produce housing, infrastructure, and energy at needed scale.
6. **Equity and Access** – who benefits from progress and how inclusion is addressed.
7. **Expertise and Epistemic Authority** – who is trusted to know and to act.
8. **Risk and Regulation** – how technological risks are governed.
9. **Public Goods and Infrastructure** – investment in and stewardship of collective assets.
...
### Toward a Metamodern Political Economy
...
### Raising the Floor: Maximin as Design Principle
...
### Polycentricity, Subsidiarity, and Resilience
...
### Designing New Institutions for a New Technological Era
...
### Scarcity vs. Abundance: A Reductive Axis
...
### The Politics of Constraint: Where Judgment Enters
...
### Interdependent Constraint Regimes: Lessig’s Pathetic Dot
...
### Neo-Modernist Blind Spots and the Case for Metamodern Governance
...
> Zargham, M. (2025). *The Politics of Progress*. Comparative and meta-analysis of techno-political ideologies. [Creative Commons CC0 1.0]. [https://mzargham.github.io/politics-of-progress/](https://mzargham.github.io/politics-of-progress/)
